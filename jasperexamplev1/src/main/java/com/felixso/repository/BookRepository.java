...
import com.felixso.domain.Book;
...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    @Query(value = "select distinct book from Book book left join fetch book.publishers",
    ...
    @Query("select book from Book book left join fetch book.publishers where book.id =:id")
