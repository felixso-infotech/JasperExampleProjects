...
import { BookService } from 'app/entities/jasperExamplev1/book/book.service';
import { IBook, Book,} from 'app/shared/model/jasperExamplev1/book.model';
        ...
        describe('Service methods', async () => {
            it('should find an element', async () => {
                const returnedFromService = Object.assign({
                    dateOfPublishing: currentDate.format(DATE_FORMAT),
                }, elemDefault);
                service
                    .find(123)
